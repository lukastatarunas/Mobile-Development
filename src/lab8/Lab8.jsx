...
import failSound from '../../assets/no.mp3';
import succesSound from '../../assets/applaud.mp3';
...
const Lab8 = () => {
    ...
    const playSuccess = async () => {
        ...
        ToastAndroid.show('Success! Your circle is bigger than the given circle!', ToastAndroid.SHORT)
    ...
    const playFail = async () => {
        ...
        ToastAndroid.show('Fail! Your circle is smaller than the given circle!', ToastAndroid.SHORT)
    ...
    return (
        ...
        >
            ...
            >
                {/* Required for ios */}
                <Animated.View style={[styles.panHandler, { backgroundColor: colors.black }]}>
                    <Svg
                        height="100%"
                        width="100%"
